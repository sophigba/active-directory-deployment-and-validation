...
The attack targeted the RDP service on the Target-PC using a curated password list to simulate a credential-stuffing attempt against the `b.shark` account.<br>
